...
class QuicMetrics:
    ...
    @property
    def avg_handshake_ms(self) -> float | None: ...
...
class TestSummary:
    ...
    @property
    def avg_connection_latency_us(self) -> float: ...
    @property
    ...
    @property
    def chaos_faults_by_type(self) -> dict[str, int]: ...
    @property
    def std_dev_latency_ms(self) -> float: ...
    @property
